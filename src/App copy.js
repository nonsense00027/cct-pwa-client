    ...
    <div className="container-fluid content-div">
      <div className="row">
        <div className="col-12">
          <div className="d-flex" onClick={() => setNavOpen(true)}>
            <div className="toggle-sidebar-icon">
              ...
              >
                <path
                  d="M0.25 11.25H19.75V9.08333H0.25V11.25ZM0.25 15.5833H19.75V13.4167H0.25V15.5833ZM0.25 6.91666H19.75V4.74999H0.25V6.91666ZM0.25 0.416656V2.58332H19.75V0.416656H0.25Z"
                  fill="#5A5A5A"
                />
              </svg>
            </div>
            ...
            <ul className="ul-navbar">
              ...
              <li>
                <a href="/clinic">
                  ...
                  >
                    <path
                      d="M10.8333 6.99999H16.6666V8.24999H10.8333V6.99999ZM10.8333 4.91666H16.6666V6.16666H10.8333V4.91666ZM10.8333 9.08333H16.6666V10.3333H10.8333V9.08333ZM17.5 0.333328H2.49998C1.58331 0.333328 0.833313 1.08333 0.833313 1.99999V12.8333C0.833313 13.75 1.58331 14.5 2.49998 14.5H17.5C18.4166 14.5 19.1666 13.75 19.1666 12.8333V1.99999C19.1666 1.08333 18.4166 0.333328 17.5 0.333328ZM17.5 12.8333H9.99998V1.99999H17.5V12.8333Z"
                      fill="#7C7C7C"
                    />
                  </svg>
                  Clinics
